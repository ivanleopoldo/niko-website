            ...
            case 2: {
                return (
                    <div>
                            ...
                            {provinces.map(({ prov_code, name }) => {
                                return (
                                    <option
                                        ...
                                        value={name}
                                        selected={
                                            info.locationInfo.provName === name
                                                ? true
                                                : false
                                        }
                                    >
                        ...
                        {!!info.locationInfo.provName && (
                            <>
                                ...
                                >
                                    ...
                                    {getCityMunByProvince(
                                        info.locationInfo.provCode
                                    ).map(({ name, prov_code, mun_code }) => {
                                        return (
                                            <option
                        ...
                        <button
                            disabled={
                                !(isAnError("address") && isAnError("zipCode"))
                            }
                            onClick={nextStep}
                ...
                return (
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            value={
                                info.basicInfo.lastName === null
                                    ? ""
                                    : info.basicInfo.lastName
                            }
                            type="text"
                        ...
                        {info.basicInfo.isFreelancer && (
                            <>
                                ...
                                <Range
                                    ...
                                    onChange={(e) =>
                                        handler.FreelancerInfoHandler(e)
                                    }
                                />
                                <label className="label">
                                    <span className="label-text">
